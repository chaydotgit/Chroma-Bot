const { SlashCommandBuilder, Message, User } = require('discord.js');
...
module.exports = {
    ...
    async execute (interaction) {
        interaction.client.users.send('186685751285514240', `The user @${interaction.user.username} sent the following ticket: ${interaction.options.getString('message')}`);
